  ...
  useEffect(() => {
    ...
    if (typeof window !== "undefined" && !window.gtranslateSettings) {
      ...
      window.gtranslateSettings = {
        ...
        languages: [
          "en", "fr", "es", "de", "it", "pt", "ru", "zh-CN", "zh-TW", "ja", "ko",
          "ar", "hi", "nl", "pl", "tr", "sv", "da", "no", "fi", "el", "cs", "ro",
          "hu", "uk", "th", "vi", "id", "ms", "tl", "bn", "ur", "fa", "he", "sw",
          "am", "ha", "yo", "ig", "zu", "af", "bg", "hr", "sk", "sl", "sr", "lt",
          "lv", "et", "ka", "az", "kk", "uz", "my", "km", "lo", "ne", "si", "mn",
          "ps", "ku", "sq", "mk", "bs", "mt", "is", "gl", "ca", "eu",
        ],
