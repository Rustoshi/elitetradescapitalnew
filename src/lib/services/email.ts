...
const EMAIL_FROM = process.env.EMAIL_FROM || process.env.SMTP_USER || "noreply@primecrest.xyz";
...
export async function sendWelcomeEmail(
  ...
  const content = `
    ...
    <p style="margin: 0 0 24px 0; color: #334155; font-size: 16px; line-height: 1.6;">
      Use the temporary password provided to you by the administrator to sign in. For security reasons, please change your password immediately after your first login.
    </p>
