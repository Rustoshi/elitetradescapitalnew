...
export const currencies: Currency[] = [
  ...
  { code: "BAM", name: "Bosnia Mark", symbol: "KM", country: "Bosnia and Herzegovina" },
  ...
  { code: "KGS", name: "Kyrgyzstani Som", symbol: "сом", country: "Kyrgyzstan" },
  ...
  { code: "STN", name: "Sao Tome Dobra", symbol: "Db", country: "Sao Tome and Principe" },
  ...
  { code: "ANG", name: "Netherlands Antillean Guilder", symbol: "ƒ", country: "Curacao" },
  ...
  // Crypto (popular)
  { code: "BTC", name: "Bitcoin", symbol: "₿", country: "Decentralized" },
  { code: "ETH", name: "Ethereum", symbol: "Ξ", country: "Decentralized" },
  { code: "USDT", name: "Tether", symbol: "₮", country: "Decentralized" },
  { code: "USDC", name: "USD Coin", symbol: "$", country: "Decentralized" },
];
